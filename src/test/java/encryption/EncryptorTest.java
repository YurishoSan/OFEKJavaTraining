 ...
 *
 * Test encryption.Encryptor class
 */
public class EncryptorTest {
    ...
    public void EncryptNoneShouldNotChangeTheFileContent() throws IOException {
        encryptor.setAlgorithmType(encryption.AlgorithmTypeEnum.NONE);
    ...
    public void EncryptCaesarShouldEncryptTheFileContent() throws IOException {
        ...
        encryptor.setAlgorithmType(encryption.AlgorithmTypeEnum.CAESAR);
