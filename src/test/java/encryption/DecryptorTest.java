 ...
 *
 * Test encryption.Decryptor class
 */
public class DecryptorTest {
    ...
    public void setUpDecryptor() throws IOException {
        ...
        decryptor = new Decryptor(testFilePath + ".encrypted", new NoneDecryptionAlgorithmDecorator(new BasicAlgorithm(), key));
    }
    ...
    public void DecryptNoneShouldNotChangeTheFileContent() throws IOException {
        decryptor.setAlgorithmType(encryption.AlgorithmTypeEnum.NONE);
    ...
    public void DecryptCaesarShouldDecryptTheFileContent() throws IOException {
        ...
        decryptor.setAlgorithmType(encryption.AlgorithmTypeEnum.CAESAR);
